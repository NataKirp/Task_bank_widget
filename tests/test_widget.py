...
def test_mask_account_card():
    ...
    assert (
            mask_account_card("МИР 6831982476737658")
            == "МИР 6831 98** **** 7658"
    )
...
@pytest.mark.parametrize(
    "bank_details",
    [
        "Schet 73654108430135874305",
        "Счет 71583007347267585999414228426353",
        "Счет 73654",
        "Счет 0",
        "Счет ",
        "Visa Platinum 70007922896063616831982476737658" "Visa Platinum 70007",
        "Visa Classic ",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "15.08.25",
        "Wed, 12 April 2023",
        "2024-13-11T02:26:18.671407" "152000",
        "",
    ],
)
